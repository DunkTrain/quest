...
<div class="container-fluid">
            ...
            <div class="container" >
                ...
                <div class="form-group">
                    <label class="custom-radio">
                        <input type="radio" name="startRadioOptions" value="<%=option%>">
                        <%=option%>
                    </label>
                </div>
                <%
    ...
    <div class="spoiler">
        ...
        <div class="spoiler_content">
            <br>
            <p class="text_hide">name: ${sessionScope.name}</p>
            <p class="text_hide">number of attempts: ${sessionScope.counter}</p>
        </div>
